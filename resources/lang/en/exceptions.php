...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'quiz' => [
            'rules'=>[
                'already_exists' => 'That Rule already exist. Please choose different name.',
                'create_error'   => 'There was problem creating this rule. Please try again.',
                'update_error'   => 'There was problem updating this rule. Please try again.',
                'delete_error'   => 'There was problem deleting this rule. Please try again.',
            ],
            'boards'=>[
                'already_exists' => 'That Board already exist. Please choose different name',
                'create_error'   => 'There was problem creating this board. Please try again.',
                'update_error'   => 'There was problem updating this board. Please try again.',
                'delete_error'   => 'There was problem deleting this board. Please try again.',
            ],
            'sets'=>[
                'already_exists' => 'That Set already exist. Please choose different name',
                'create_error'   => 'There was problem creating this set. Please try again.',
                'update_error'   => 'There was problem updating this set. Please try again.',
                'delete_error'   => 'There was problem deleting this set. Please try again.',
            ],
        ],
    ],
